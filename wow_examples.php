	...
	<?php for ( $i = 1; $i <= 3; $i ++ ): ?>
		<div class="accordion-item">
			<h5 class="accordion-item__title"
			    ...
			    aria-controls="collapse-<?php echo $i ?>">Collapsible Group Item #<?php echo $i; ?></h5>
			<div id="collapse-<?php echo $i ?>"
			     class="accordion-item__body collapse <?php echo $i == 1 ? 'show' : ''; ?>"
			     aria-labelledby="heading-<?php echo $i ?>"
			     data-parent="#accordion-example">
				<?php echo file_get_contents( 'http://loripsum.net/api/1/medium/' ); ?>
			</div>
		</div>
	<?php endfor; ?>
</div>
...
<div class="nav nav-tabs" id="nav-tab" role="tablist">
	<?php for ($i = 1; $i <= 3; $i++):  ?>
		<a class="nav-item nav-link <?php echo $i == 1 ? 'active' : ''; ?>"
		   id="nav-<?php echo $i; ?>-tab"
		   aria-selected="<?php echo $i == 1 ? 'true' : 'false'; ?>"
		   data-toggle="tab"
		   href="#nav-<?php echo $i; ?>"
		   role="tab"
		   aria-controls="nav-<?php echo $i; ?>">Tab <?php echo $i; ?></a>
	<?php endfor; ?>
</div>
<div class="tab-content" id="nav-tab-content">
	<?php for ($i = 1; $i <= 3; $i++):  ?>
		<div class="tab-pane fade <?php echo $i == 1 ? 'show active' : '';?>" id="nav-<?php echo $i; ?>" role="tabpanel" aria-labelledby="nav-<?php echo $i; ?>-tab">
			<?php echo file_get_contents( 'http://loripsum.net/api/1/medium/' ); ?>
		</div>
	<?php endfor; ?>
</div>
