...
add_action( 'tgmpa_register', 'bootstrap_register_required_plugins' );

/**
 * Register the required plugins for this theme.
 *
 */
function bootstrap_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'bootstrap',                 // Unique ID for hashing notices for multiple instances of TGMPA.
